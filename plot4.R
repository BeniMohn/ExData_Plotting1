...
# Result: 
# =======
# The script will create a Graphik called "plot4.png" in the 
...
# In this part the png file is created with the disered plots. 
...
# first graphik (upper left)
plot(plot_data$CompleteDate, plot_data$Global_active_power, type="l", ylab = "Global Active Power (kilowatts)", xlab="")

# second graphik (upper right)
plot(plot_data$CompleteDate,plot_data$Voltage, type="l", xlab = "datetime", ylab = "Voltage")

# third graphik (bottom left)
plot(plot_data$CompleteDate, plot_data$Sub_metering_1, xlab="", ylab = "Energy sub metering", type="n")
with(plot_data, {lines(CompleteDate, Sub_metering_1, col="black")
        lines(CompleteDate, Sub_metering_2, col="red")
        lines(CompleteDate, Sub_metering_3, col="blue")
        legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
               col=c("black", "red", "blue"), lty=c(1,1,1), xjust=0.5, bty="n") })

# fourth graphik (bottom right)
plot(plot_data$CompleteDate,plot_data$Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()